...
verify_once() {
    ...
    check_exists "windows/run-wpf-smoke.ps1" "Windows setup wizard WPF smoke runner"
    ...
    check_exists "windows/lib/Ev3ConnectionChecks.psm1" "Windows setup wizard Phase D EV3 guided setup actions"
    ...
    check_json "windows/03-evidence-templates/windows-setup-wizard-wpf-smoke.template.json" "Windows WPF smoke evidence template"
