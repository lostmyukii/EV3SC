...
| Full VSLE Bluetooth smoke evidence gate | `/Users/yukii/Desktop/EV3SC/scripts/run_vsle_bluetooth_smoke.py`, `/Users/yukii/Desktop/EV3SC/tests/test_vsle_bluetooth_smoke.py`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_full_module_smoke.template.json`, `/Users/yukii/Desktop/EV3SC/docs/classroom/REAL_EV3_SMOKE_HANDOFF.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/REAL_EV3_REHEARSAL.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_full_module_smoke.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_self_use_unsigned.md` | Validates real full-module `vsle-bluetooth` evidence with separate verdicts for self-use unsigned functional regression, the no-WiFi Bluetooth classroom baseline, and the Bluetooth high-speed 50Hz gate. The `--self-use-unsigned` lane can accept real command-group evidence without release-artifact install and writes `docs/classroom/vsle_bluetooth_self_use_unsigned.md`, but the classroom baseline still requires release artifact install, ev3dev server runtime, measured Bluetooth sampling, every command group, unsandboxed Scratch loading, and disconnect stop behavior; the 25ms freshness target no longer blocks baseline acceptance unless a lesson explicitly requires 50Hz raw streaming. |
