...
| Full VSLE Bluetooth smoke evidence gate | `/Users/yukii/Desktop/EV3SC/scripts/run_vsle_bluetooth_smoke.py`, `/Users/yukii/Desktop/EV3SC/tests/test_vsle_bluetooth_smoke.py`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_full_module_smoke.template.json`, `/Users/yukii/Desktop/EV3SC/docs/classroom/REAL_EV3_REHEARSAL.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_full_module_smoke.md` | Validates real full-module `vsle-bluetooth` classroom smoke evidence for release artifact install, ev3dev server runtime, sensor freshness, every command group, unsandboxed Scratch loading, and disconnect stop behavior before classroom readiness can be claimed; reports command-group-passing but freshness-blocked evidence as a non-classroom diagnostic/fallback mode |
