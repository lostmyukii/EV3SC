...
| Desktop release artifact packager and notarization helper | `/Users/yukii/Desktop/EV3SC/desktop/scripts/build_release_artifacts.py`, `/Users/yukii/Desktop/EV3SC/desktop/scripts/check_macos_release_preflight.py`, `/Users/yukii/Desktop/EV3SC/desktop/scripts/run_macos_release_flow.py`, `/Users/yukii/Desktop/EV3SC/desktop/scripts/notarize_macos_release.py`, `/Users/yukii/Desktop/EV3SC/desktop/scripts/build_macos_pkg.py`, `/Users/yukii/Desktop/EV3SC/tests/test_desktop_release_packaging.py`, `/Users/yukii/Desktop/EV3SC/tests/test_macos_release_preflight.py`, `/Users/yukii/Desktop/EV3SC/tests/test_macos_release_flow.py`, `/Users/yukii/Desktop/EV3SC/tests/test_macos_notarization.py`, `/Users/yukii/Desktop/EV3SC/tests/test_macos_pkg_packaging.py`, `/Users/yukii/Desktop/EV3SC/desktop/README.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/MACOS_INSTALL.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/WINDOWS_INSTALL.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/WEISILELINK_DESKTOP.md` | Reproducible app/zip/manifest packaging from self-contained executables, local macOS release prerequisite checks that auto-detect standard local build outputs plus unique Developer ID Application/Installer identities and verify the notarytool profile from an explicit argument or `WEISILE_NOTARY_KEYCHAIN_PROFILE`, a guarded macOS release-flow runner that refuses to sign/notarize/package until preflight reports `Ready: yes`, macOS native Bluetooth adapter bundling, unsigned-artifact refusal by default, `xcrun notarytool` submission, `xcrun stapler` staple/validate, signed macOS `.pkg` creation with `pkgbuild`/`productbuild`, localhost release defaults, and explicit non-classroom status until signing/notarization and clean-machine evidence pass |
