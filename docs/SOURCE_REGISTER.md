...
| Official EV3 native-adapter transport shell | `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/transport/official_ev3_bt_transport.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_official_ev3_bt_transport.py` | Native adapter boundary, explicit unsupported behavior without adapter injection, safe all-motor stop on disconnect, and CLI `official-bluetooth` entry without claiming macOS/Windows support |
