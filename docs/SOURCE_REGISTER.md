...
| WeisileLink classroom roster support | `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/desktop/profiles.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/desktop/roster.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/desktop/pairing.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/desktop/runtime.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_desktop_profiles.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_desktop_roster.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_desktop_runtime.py`, `/Users/yukii/Desktop/EV3SC/docs/classroom/EV3_CLASSROOM_PROVISIONING_DESIGN.md` | Non-secret classroom roster import/export, S1-S4 expected sensor layout storage, profile/roster merge behavior, and Desktop ready-check validation that requires expected real sensor ports before reporting ready for a paired EV3. |
| WeisileLink fleet maintenance commands | `/Users/yukii/Desktop/EV3SC/ev3-firmware/vsle_ev3_server.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/transport/bluetooth_transport.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/desktop/maintenance.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/desktop/profiles.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/desktop/runtime.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/desktop/supervisor.py`, `/Users/yukii/Desktop/EV3SC/tests/test_ev3_server.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_bluetooth_transport.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_desktop_maintenance.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_desktop_runtime.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_desktop_supervisor.py` | Authenticated `auth.rotate` token rotation, Desktop `desktop-device list/select/rename`, Desktop `desktop-token rotate`, guarded `desktop-token recover`, and `desktop-start`/`desktop-supervise` multi-EV3 profile selection behavior that never prints raw old/new pairing tokens and preserves non-secret roster data during lost-token recovery. |
| Desktop fleet rehearsal gate | `/Users/yukii/Desktop/EV3SC/scripts/run_desktop_fleet_rehearsal.py`, `/Users/yukii/Desktop/EV3SC/tests/test_desktop_fleet_rehearsal.py`, `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/desktop-fleet-rehearsal.json`, `/Users/yukii/Desktop/EV3SC/docs/desktop/DESKTOP_FLEET_REHEARSAL.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/EV3_CLASSROOM_PROVISIONING_DESIGN.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/WEISILELINK_DESKTOP.md`, `/Users/yukii/Desktop/EV3SC/desktop/README.md` | Simulated 10-device classroom fleet gate that imports a token-free roster, saves paired Desktop profiles through secure credential references, selects each EV3, runs startup/supervisor readiness checks for each profile, rejects fewer than 10 devices, and writes token-safe simulated evidence before signed clean-machine package evidence. |
| WeisileLink desktop diagnostics implementation | `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/desktop/diagnostics.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_desktop_diagnostics.py` | Desktop diagnostic bundle generation and redaction behavior for pairing tokens, API keys, Bluetooth addresses, oversized labels, and default exclusion of student raw data |
| WeisileLink structured logging | `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/observability/logging.py` | Existing token redaction and 64-character label bound reused as the privacy baseline for desktop diagnostics |
| Desktop install smoke evidence gate | `/Users/yukii/Desktop/EV3SC/scripts/run_desktop_install_smoke.py`, `/Users/yukii/Desktop/EV3SC/tests/test_desktop_install_smoke.py`, `/Users/yukii/Desktop/EV3SC/desktop/macos/native/README.md`, `/Users/yukii/Desktop/EV3SC/desktop/windows/native/README.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/MACOS_INSTALL.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/WINDOWS_INSTALL.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/WEISILELINK_DESKTOP.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/macos-vsle-bluetooth-install-smoke.template.json`, `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/windows-vsle-bluetooth-install-smoke.template.json` | Release-artifact install evidence validation for reboot startup, Scratch Link endpoint, installed `desktop-diagnostics` export/redaction evidence, mode-specific real EV3 Bluetooth smoke, native adapter boundaries, release manifest signed/notarized status, signed macOS package fields, signed Windows installer fields, and rejection of localhost-only developer runs. The default mode validates official-firmware compatibility with `official_firmware_bt_real_ev3_ok`; `--mode vsle-bluetooth` validates the no-WiFi full VSLE classroom path with `vsle_bluetooth_real_ev3_ok` plus `vsle_bluetooth_sensor_ready`; platform templates are blocked by default and must be copied only during clean-machine evidence collection. |
| Desktop release evidence readiness reports | `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/release-evidence-readiness-20260603.json`, `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/release-evidence-readiness-20260603.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/macos-release-preflight.json`, `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/macos-release-flow.json`, `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/windows-release-preflight.json`, `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/windows-release-flow.json` | Release-readiness blocker evidence showing the guarded macOS and Windows release flows stop at preflight, execute zero release commands, and require external signing/notarization or Windows build-host inputs before clean-machine EV3 Bluetooth install smoke evidence can be collected. |
| Desktop release artifact packager and notarization helper | `/Users/yukii/Desktop/EV3SC/desktop/scripts/build_weisilelink_executable.py`, `/Users/yukii/Desktop/EV3SC/desktop/scripts/build_release_artifacts.py`, `/Users/yukii/Desktop/EV3SC/desktop/scripts/check_macos_release_preflight.py`, `/Users/yukii/Desktop/EV3SC/desktop/scripts/run_macos_release_flow.py`, `/Users/yukii/Desktop/EV3SC/desktop/scripts/notarize_macos_release.py`, `/Users/yukii/Desktop/EV3SC/desktop/scripts/build_macos_pkg.py`, `/Users/yukii/Desktop/EV3SC/desktop/windows/build_release.ps1`, `/Users/yukii/Desktop/EV3SC/tests/test_desktop_executable_build.py`, `/Users/yukii/Desktop/EV3SC/tests/test_desktop_release_packaging.py`, `/Users/yukii/Desktop/EV3SC/tests/test_windows_release_handoff.py`, `/Users/yukii/Desktop/EV3SC/tests/test_macos_release_preflight.py`, `/Users/yukii/Desktop/EV3SC/tests/test_macos_release_flow.py`, `/Users/yukii/Desktop/EV3SC/tests/test_macos_notarization.py`, `/Users/yukii/Desktop/EV3SC/tests/test_macos_pkg_packaging.py`, `/Users/yukii/Desktop/EV3SC/desktop/README.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/MACOS_INSTALL.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/WINDOWS_INSTALL.md`, `/Users/yukii/Desktop/EV3SC/docs/desktop/WEISILELINK_DESKTOP.md` | Reproducible PyInstaller executable builds on the target OS, including `desktop/build/windows/WeisileLink.exe` via `--target windows`, Windows preflight build-host handoff commands for missing executables, a Windows PowerShell handoff that reads `WEISILE_WINDOWS_SIGN_IDENTITY` and `WEISILE_WINDOWS_TIMESTAMP_URL`, runs executable build, preflight, and guarded signed release flow without `--allow-unsigned`, app/zip/manifest packaging from self-contained executables, local macOS release prerequisite checks that auto-detect standard local build outputs plus unique Developer ID Application/Installer identities and verify the notarytool profile from an explicit argument or `WEISILE_NOTARY_KEYCHAIN_PROFILE`, a guarded macOS release-flow runner that refuses to sign/notarize/package until preflight reports `Ready: yes` and records `Preflight Blocking Checks` plus `Release Commands After Preflight Passes` when blocked, macOS native Bluetooth adapter bundling, unsigned-artifact refusal by default, `xcrun notarytool` submission, `xcrun stapler` staple/validate, signed macOS `.pkg` creation with `pkgbuild`/`productbuild`, localhost release defaults, and explicit non-classroom status until signing/notarization and clean-machine evidence pass |
...
| Official EV3 Direct Command encoder/decoder | `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/protocol/official_ev3_direct_command.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_official_ev3_direct_command.py` | Project-owned encoder/decoder and tests for source-backed official firmware command frames, Direct Reply validation, SI float globals, signed int32 motor globals, device-list polling, sensor polling, and motor count polling |
| Official EV3 native-adapter transport and polling | `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/transport/official_ev3_bt_transport.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_official_ev3_bt_transport.py` | Native adapter boundary, explicit unsupported behavior without adapter injection, safe all-motor stop on disconnect, CLI `official-bluetooth` entry, and fake-adapter verified Direct Reply sensor/motor polling into SensorCache without claiming macOS/Windows classroom support |
| Scratch Link macOS Bluetooth Classic session | `/Users/yukii/Desktop/scratch ai/scratch-link/scratch-link-mac/BT/MacBTSession.cs`, `/Users/yukii/Desktop/scratch ai/scratch-link/scratch-link-mac/BT/Rfcomm/RfcommChannelEventDelegate.cs` | Source-backed macOS IOBluetooth RFCOMM channel 1 open/polling behavior and data/closed callbacks adapted into the EV3SC-owned app-bundled native adapter |
| macOS native adapter process bridge | `/Users/yukii/Desktop/EV3SC/desktop/macos/native/WeisileEV3BluetoothAdapter.m`, `/Users/yukii/Desktop/EV3SC/desktop/macos/native/build.sh`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/transport/native_adapter_process.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_native_adapter_process.py`, `/Users/yukii/Desktop/EV3SC/desktop/macos/weisile-link.launchd.plist` | EV3SC-owned JSON-line bridge that keeps macOS Bluetooth APIs outside Python, launches the bundled adapter `.app` through LaunchServices with a localhost socket bridge, injects the executable path through `WEISILE_OFFICIAL_BT_ADAPTER`, and verifies syntax/error/close behavior without claiming classroom readiness |
...
| Full VSLE Bluetooth transport alias and status | `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/transport/selector.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/runtime/degradation.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/sessions.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_transport_selector.py` | Defines `vsle-bluetooth` as the canonical full-module Bluetooth transport, preserves `bluetooth` as a backward-compatible alias, and reports full capability separately from `official-bluetooth` compatibility mode |
| Shared native byte-stream adapter boundary | `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/transport/native_byte_stream.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/transport/native_adapter_process.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/transport/bluetooth_transport.py`, `/Users/yukii/Desktop/EV3SC/weisile-link/weisile_link/transport/official_ev3_bt_transport.py`, `/Users/yukii/Desktop/EV3SC/desktop/macos/native/WeisileEV3BluetoothAdapter.m`, `/Users/yukii/Desktop/EV3SC/weisile-link/tests/test_native_adapter_process.py` | Provides the project-owned byte stream boundary shared by full VSLE JSON-line Bluetooth and official-firmware Direct Command compatibility without conflating their protocols or readiness claims |
| EV3 full VSLE RFCOMM listener setup | `/Users/yukii/Desktop/EV3SC/ev3-firmware/vsle_ev3_server.py`, `/Users/yukii/Desktop/EV3SC/ev3-firmware/systemd/vsle-ev3-server.service`, `/Users/yukii/Desktop/EV3SC/ev3-firmware/scripts/install.sh`, `/Users/yukii/Desktop/EV3SC/docs/EV3DEV_SETUP.md`, `/Users/yukii/Desktop/EV3SC/ev3-firmware/README.md`, `/Users/yukii/Desktop/EV3SC/tests/test_ev3_autostart_assets.py`, `/Users/yukii/Desktop/EV3SC/tests/test_ev3_server.py` | Documents and verifies the ev3dev-only RFCOMM listener for full VSLE Bluetooth, disabled by default and enabled only through explicit EV3 setup configuration |
| Full VSLE Bluetooth smoke evidence gate | `/Users/yukii/Desktop/EV3SC/scripts/run_vsle_bluetooth_smoke.py`, `/Users/yukii/Desktop/EV3SC/tests/test_vsle_bluetooth_smoke.py`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_full_module_smoke.template.json`, `/Users/yukii/Desktop/EV3SC/docs/classroom/REAL_EV3_SMOKE_HANDOFF.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/REAL_EV3_REHEARSAL.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_full_module_smoke.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_self_use_unsigned.md` | Validates real full-module `vsle-bluetooth` evidence with separate verdicts for self-use unsigned functional regression, the no-WiFi Bluetooth classroom baseline, `Release-artifact evidence ready`, and the Bluetooth high-speed 50Hz gate. Bluetooth classroom baseline does not require release-artifact evidence; the baseline requires ev3dev server runtime, measured Bluetooth sampling, every command group, unsandboxed Scratch loading, and disconnect stop behavior. The `--self-use-unsigned` lane writes `docs/classroom/vsle_bluetooth_self_use_unsigned.md`, and the 25ms freshness target no longer blocks baseline acceptance unless a lesson explicitly requires 50Hz raw streaming. |
| VSLE Bluetooth sensor and motor port matrix gate | `/Users/yukii/Desktop/EV3SC/scripts/run_vsle_bluetooth_sensor_port_matrix.py`, `/Users/yukii/Desktop/EV3SC/tests/test_vsle_bluetooth_sensor_port_matrix.py`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_sensor_port_matrix.template.json`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_sensor_port_matrix.json`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_sensor_port_matrix.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/REAL_EV3_SMOKE_HANDOFF.md` | Validates claimed real EV3 sensor and motor port combinations for self-use `vsle-bluetooth` regression. A declared sensor port/type must include a matching latest payload with type-specific fields, and a declared motor port must include observed position, speed, and running fields; untested ports remain visible in the report instead of silently counting as covered. |
| Mac browser full VSLE Bluetooth smoke gate | `/Users/yukii/Desktop/EV3SC/scripts/run_macos_browser_vsle_bluetooth_smoke.py`, `/Users/yukii/Desktop/EV3SC/tests/test_macos_browser_vsle_bluetooth_smoke.py`, `/Users/yukii/Desktop/EV3SC/docs/classroom/macos_browser_vsle_bluetooth_smoke.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/evidence/scratchai_browser_unsandboxed_20260529.json`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_full_module_smoke.json` | Combines ScratchAI browser Unsandboxed extension-load evidence with real `vsle-bluetooth` command-group evidence to validate the server-side Scratch EV3 module path from a Mac browser when Windows is unavailable, while keeping signed release-artifact, macOS notarization, high-speed 50Hz, and Windows evidence as separate readiness gates. |
| ScratchAI teacher block rehearsal gate | `/Users/yukii/Desktop/EV3SC/scripts/run_scratchai_teacher_block_rehearsal.py`, `/Users/yukii/Desktop/EV3SC/tests/test_scratchai_teacher_block_rehearsal.py`, `/Users/yukii/Desktop/EV3SC/docs/classroom/scratchai_teacher_block_rehearsal.template.json`, `/Users/yukii/Desktop/EV3SC/docs/classroom/SCRATCHAI_TEACHER_BLOCK_REHEARSAL.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/SCRATCHAI_BROWSER_REHEARSAL.md`, `/Users/yukii/Desktop/EV3SC/docs/classroom/REAL_EV3_SMOKE_HANDOFF.md` | Validates the teacher-facing ScratchAI browser workflow after the Mac-first Bluetooth baseline: the website must keep the standard Scratch visual design, load VSLE-EV3 as an Unsandboxed main-thread script, select `Bluetooth Full VSLE`/`vsle-bluetooth`, stay on local WeisileLink JSON-RPC instead of browser direct Bluetooth, show connection state from WeisileLink health and sensor freshness, and exercise at least one Scratch block from each EV3 module. |
| VSLE Bluetooth release evidence bridge | `/Users/yukii/Desktop/EV3SC/scripts/apply_vsle_bluetooth_install_evidence.py`, `/Users/yukii/Desktop/EV3SC/tests/test_vsle_bluetooth_release_evidence_bridge.py`, `/Users/yukii/Desktop/EV3SC/docs/classroom/vsle_bluetooth_release_evidence_bridge.md`, `/Users/yukii/Desktop/EV3SC/scripts/run_desktop_install_smoke.py`, `/Users/yukii/Desktop/EV3SC/docs/desktop/evidence/macos-vsle-bluetooth-install-smoke.template.json` | Applies accepted `--mode vsle-bluetooth` clean-machine release install evidence to the full VSLE Bluetooth classroom smoke JSON only after the install smoke validator accepts the release artifact, diagnostics export/redaction bundle, and real Bluetooth sensor readiness, preventing manual edits from falsely marking `installed_from_release_artifact: true`. |
