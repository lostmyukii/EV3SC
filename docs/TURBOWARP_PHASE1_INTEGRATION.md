...
- The full current extension block surface: 62 blocks total, including the
  34-block Phase 1 surface, the 14 sound/display blocks, and the 14
  system/data collection blocks.
