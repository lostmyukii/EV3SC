...
- The full current extension block surface: 64 blocks total, including the
  34-block Phase 1 surface, the 14 sound/display blocks, the 14
  system/data collection blocks, and the 2 Phase 3 motor PID blocks.
