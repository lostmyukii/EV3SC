...
| sensor-stream-freshness | FAIL | Measured 0.00Hz for 0.2 minutes, dropped 0.000%, memory +0.0MB. |
...
- `docs/classroom/evidence/real_ev3_usb_smoke_evidence_20260601.json`
- `docs/classroom/evidence/real_ev3_usb_smoke_transcript_20260601.json`
...
Classroom pilot remains blocked until these evidence gates pass: scratchai-unified-stack, motor-command-safety, sensor-stream-freshness, aiquest-collection-training-export, multi-device-rehearsal.
