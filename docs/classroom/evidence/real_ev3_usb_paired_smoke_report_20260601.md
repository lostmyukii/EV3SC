...
| sensor-stream-freshness | FAIL | Measured 6.20Hz for 0.2 minutes, dropped 0.000%, memory +0.0MB. |
...
- `docs/classroom/evidence/real_ev3_usb_paired_smoke_evidence_20260601.json`
- `docs/classroom/evidence/real_ev3_usb_paired_smoke_transcript_20260601.json`
