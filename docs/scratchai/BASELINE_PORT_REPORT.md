...
| `.venv/bin/python -m pytest weisile-link/tests -q` | exits 0 | passed; 117 WeisileLink tests cover existing Scratch Link compatibility, sensor routing, Trainer routes, the AI Quest contract path, provider abstraction, and raw time-series governance |
