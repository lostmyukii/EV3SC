...
const {isTextToSpeechExtensionEnabled} = require('../../util/ai-feature-flags');
 ...
 * @type {string}
 */
const SERVER_HOST = readEnvString('SCRATCH_AI_TEXT_TO_SPEECH_SERVICE_URL');
...
class Scratch3Text2SpeechBlocks {
    ...
    speakAndWait (args, util) {
        if (!isTextToSpeechExtensionEnabled() || !SERVER_HOST) {
            log.warn('Text to Speech extension is disabled or not configured.');
