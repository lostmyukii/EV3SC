...
const {insertScratchAIScriptDraft} = require('./util/scratch-ai-script-draft');
...
class VirtualMachine extends EventEmitter {
    ...
    /**
     * Insert a reviewed Scratch AI script draft into the selected target.
     * @param {!object} draft Server-validated Scratch AI script draft.
     * @param {?string} targetId Optional target id; defaults to the editing target.
     * @returns {!object} Insert summary.
     */
    insertScratchAIScriptDraft (draft, targetId) {
