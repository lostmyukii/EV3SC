...
import AILogicCoach from '../ai-logic-coach/ai-logic-coach.jsx';
...
const GUIComponent = props => {
    ...
    return (<MediaQuery minWidth={layout.fullSizeMinWidth}>{isFullSize => {
        ...
        const shouldShowAILogicCoach = aiFeatureFlags.scratchAIPanelEnabled && !isFullScreen;
