...
const WISTIA_HOST = ['fast', 'wistia', 'com'].join('.');
...
class VideoStep extends React.Component {
    ...
    componentDidMount () {
        ...
        script.src = `https://${WISTIA_HOST}/embed/medias/${this.props.video}.jsonp`;
        script.async = true;
        script.setAttribute('id', 'wistia-video-content');
        document.body.appendChild(script);

        const script2 = document.createElement('script');
        script2.src = `https://${WISTIA_HOST}/assets/external/E-v1.js`;
        script2.async = true;
                ...
                <div className={styles.cardContainer}>
                    <div className={styles.card}>
                        ...
                        <div className={expanded ? styles.stepBody : styles.hidden}>
                            ...
                            {showTrackingPixels && steps[step].trackingPixel && steps[step].trackingPixel}
                        </div>
                        <NextPrevButtons
                            expanded={expanded}
                            isRtl={isRtl}
...
Cards.propTypes = {
    ...
    showTrackingPixels: PropTypes.bool,
