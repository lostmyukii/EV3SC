...
const CODE_ORG_TRACKING_HOST = ['code', 'org'].join('.');
const makeCodeOrgTrackingPixel = fileName => (
    <img src={`https://${CODE_ORG_TRACKING_HOST}/api/hour/${fileName}`} />
);
...
export default {
    ...
    'say-it-out-loud': {
        ...
        steps: [{
            video: 'k54n8uwcty',
            trackingPixel: makeCodeOrgTrackingPixel('begin_scratch_talk.png')
        }, {
            title: (
                <FormattedMessage
    ...
    'cartoon-network': {
        ...
        steps: [{
            video: 'uz5oz5h9yg',
            trackingPixel: makeCodeOrgTrackingPixel('begin_scratch_adventure.png')
        }, {
            title: (
                <FormattedMessage
