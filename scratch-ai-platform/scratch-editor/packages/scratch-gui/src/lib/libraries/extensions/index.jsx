...
import aiFeatureFlags from '../../ai/feature-flags.js';
...
if (aiFeatureFlags.scratchAIExtensionEnabled) {
    extensionLibrary.push({
        name: (
            <FormattedMessage
                defaultMessage="AI Logic Coach"
                description="Name for the AI Logic Coach extension"
                id="gui.extension.scratchai.name"
            />
        ),
        extensionId: 'scratchai',
        description: (
            <FormattedMessage
                defaultMessage="Ask questions and explain project logic."
                description="Description for the AI Logic Coach extension"
                id="gui.extension.scratchai.description"
            />
        ),
        featured: false
    });
...
export default extensionLibrary.filter(extension => {
    if (extension.extensionId === 'text2speech') {
        return aiFeatureFlags.scratchAITextToSpeechExtensionEnabled;
    }
    if (extension.extensionId === 'translate') {
        return aiFeatureFlags.scratchAITranslateExtensionEnabled;
    }
    return true;
});
