...
import aiFeatureFlags from '../lib/ai/feature-flags';
...
class Cards extends React.Component {
    ...
    render () {
        const props = {
            ...
            showVideos: aiFeatureFlags.scratchAIExternalTutorialVideosEnabled &&
                this.props.platform !== PLATFORM.DESKTOP &&
                this.props.platform !== PLATFORM.ANDROID,
            showTrackingPixels: aiFeatureFlags.scratchAITutorialTrackingPixelsEnabled
        };
        return (
